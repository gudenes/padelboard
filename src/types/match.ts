...
export type TemplateId =
  ...
  | "premier"
  | "minimal"
  | import("@/lib/board-styles").BoardStyleId;
...
export interface OverlayJson {
  ...
  analytics?: import("@/lib/match-analytics").MatchAnalytics;
  scoreHistory?: MatchState[];
  clock?: import("@/lib/match-clock").MatchClock;
  customDesign?: import("@/lib/custom-board").CustomBoardDesign;
